...
<footer class="ftr">
  <div class="ftr-in">
    <div class="ftr-top">
      <div class="ftr-brand">
        <div class="ftr-logo"><span class="brand-mark"></span>{$siteName} <em>{$siteEn}</em></div>
      ...
      <nav class="ftr-cols">
        <div class="ftr-col">
          ...
          <a href="/brokers.php">外汇经纪商</a>
          <a href="/reviews.php">评测</a>
        </div>
        <div class="ftr-col">
          <h4>关于</h4>
          <a href="/reviews.php">评测方法</a>
          <a href="/regulators.php">监管说明</a>
        </div>
      </nav>
    </div>
    <div class="ftr-bottom">
      <p class="ftr-disc">风险提示：外汇及差价合约交易涉及高风险，可能导致本金损失。本站评测仅供参考，不构成投资建议。请根据自身情况审慎决策。</p>
      <div class="ftr-meta">
